...
pi_sayisi = 3.14
katsayi = 2
toplam = pi_sayisi + 1 # toplam
fark = pi_sayisi - 1 # fark
carpma = pi_sayisi * 2 # carpma
bolme = pi_sayisi / 2 # bolme

# print fonksiyonu
print("Toplam: ",toplam) # print metodu degiskenleri yazdırmaya yarar
print("Fark: {}".format(fark))
print("\nÇarpma: %.1f, Bölme: %.4f" % (carpma, bolme))
